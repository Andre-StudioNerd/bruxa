function preload() {
  ...
  //imagemMorcego = loadImage('imagens/inimigos/bat2.png');
  ...
  imagemCaldeirao = loadImage('imagens/itens/caldeirao.png');
  imagemVeneno = loadImage('imagens/itens/poison.png');
  imagemSapo = loadImage('imagens/itens/sapo.png');
  imagemAranha = loadImage('imagens/itens/spider.png');
...
function setup() {
  ...
  controladorItem = new ControladorItem([moedaOuro, moedaPrata, moedaBronze, varinha, caldeirao, sapo, veneno, aranha]);
